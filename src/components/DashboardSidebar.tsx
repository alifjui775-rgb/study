      ...
      >
        ...
        <div className="p-4 border-t border-border shrink-0 flex flex-col gap-3">
          <div className="flex items-center overflow-hidden whitespace-nowrap">
            ...
            <div className={`ml-3 ${isExpanded ? "opacity-100" : "opacity-0 hidden"}`}>
          ...
          <Button
            ...
            size="sm"
            onClick={onLogout}
            className={`w-full justify-start gap-2 text-muted-foreground ${!isExpanded && "px-3"}`}
          >
...
function SidebarItemLink({ item, isExpanded, accentText }: SidebarItemLinkProps) {
  return (
    <Link
      to={item.href}
      className={`
