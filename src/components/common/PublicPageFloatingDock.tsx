...
interface PublicPageFloatingDockProps {
  isScrolled: boolean;
}

const PublicPageFloatingDock: React.FC<PublicPageFloatingDockProps> = ({ isScrolled }) => {
...
export default PublicPageFloatingDock;
