-- ============================================================
-- Fix: Apply topic/chapter/paper AND standard filters to source_b_pool
-- (Enrolled Courses) so standard filtering is consistent across
-- both Public QB (source_a_pool) and Enrolled Courses (source_b_pool).
-- ============================================================
...
BEGIN
  ...
  -- ── Source A: Public QB (topic/chapter/paper + standard & recent year filter) ──
  source_a_pool AS (
  ...
  -- ── Source B: Enrolled Courses (with topic/chapter/paper AND standard filter) ──
  source_b_pool AS (
